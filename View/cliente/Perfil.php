...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Alex+Brush&family=Inter:wght@300;400;500;600;700&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap"
        rel="stylesheet">
        ...
        <div class="main-container">
            ...
            <?php if ($usuarioNaoEncontrado): ?>
                <div class="client-error-card">
                    ...
                    <p class="error-description">Não foi possível localizar os seus dados de cadastro no sistema. Por favor,
                        faça login novamente ou contate o suporte.</p>
                </div>
            <?php else: ?>
                ...
                <form action="../../controller/SalvarPerfilCliente.php" method="POST" class="client-profile-form">
                    ...
                    <div class="profile-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                <label class="form-label" for="nome">Nome Completo <span
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="telefone" name="telefone" class="form-input" maxlength="20"
                    ...
                    <div class="profile-section password-section">
                        <div class="profile-section-header">
                            ...
                            <p class="profile-section-description">Altere sua senha de acesso. Deixe em branco caso não
                                queira alterar.</p>
                        </div>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" id="nova_senha" name="nova_senha" class="form-input" minlength="6"
