    ...
    <main class="pagina-disponibilidade">
        ...
        <?php if (!empty($appointments)): ?>
            <div style="margin-top: 15px; margin-bottom: 15px;">
                ...
                <select id="filtroData" onchange="filtrarTabelaPorData()" style="height: 38px; padding: 0 10px; border: 1px solid #ddd4c8; border-radius: 8px;">
                ...
                <select id="filtroStatus" onchange="filtrarTabelaPorData()" style="height: 38px; padding: 0 10px; border: 1px solid #ddd4c8; border-radius: 8px;">
                            ...
                            <td>
                                ...
                                <?php if ($app['Appo_status'] == 'Pendente'): ?>
                                    <form action="" method="POST" style="display:inline;">
                                        ...
                                        <button type="submit" name="action" value="accept" class="btn-acao btn-aceitar">Aceitar</button>
                                    </form>
                                <?php endif; ?>
                                ...
                                <?php if ($app['Appo_status'] == 'Confirmado'): ?>
                                    <form action="" method="POST" style="display:inline;">
                                        <input type="hidden" name="appo_id" value="<?= $app['Appo_id'] ?>">
                                        <button type="submit" name="action" value="start" class="btn-acao btn-iniciar">Iniciar</button>
                                    </form>
                                <?php endif; ?>
                                ...
                                <?php if ($app['Appo_status'] == 'Em Atendimento'): ?>
                                    <form action="" method="POST" style="display:inline;">
                                        <input type="hidden" name="appo_id" value="<?= $app['Appo_id'] ?>">
                                        <button type="submit" name="action" value="finish" class="btn-acao btn-concluir">Finalizar</button>
                                    </form>
                                <?php endif; ?>
